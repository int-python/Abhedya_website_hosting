            ...
            <div data-aos="zoom-out-left">
              <div>
                ...
                <div className="Mesage_box_two">
                  <p>
                    Your web design is a key part of the success of your online
                    business. The web design is created according to the target
          ...
          <section className="flowchart">
            <div data-aos="zoom-out-right">
              <div>
                ...
                <div className="Mesage_box">
                  <p>
                    In this stage, the design of your website is now under
                    developers. A web developer will use codes on the site to
                    make it function and run smoothly.Most of the time, the
                    landing or main page is created first, and then all other
                    web pages are added, as per the site hierarchy created as
                    mentioned in the sitemap
                  </p>
                  <span className="message_box_end"></span>
                </div>
              </div>
            ...
            <div data-aos="zoom-out-left">
              <div>
                ...
                <div className="Mesage_box_two">
                  <p>
                    LIt is another routine part of the web development process.
                    Every page and links and forms are tested before launching
                    the site to make sure nothing is broken. In this stage, your
                    site is tested for several things including- • Website speed
                    • Cross-browser compatibility • Multiple screen tests
                  </p>
                  <span className="message_box_endtwo"></span>
                </div>
              </div>
